									...
									<div class="row">
										...
										<div class="form-group col-md-6">
											<label for="lbl_tipo"><span style="color:red;">(*)</span>Género:<br/><br/>
												<input id="genero" type="radio" name="genero" value="Hombre" <?= ($alum_view['alum_genero']==1?' checked':'') ?> />
													<label for="" style="margin-right: 50px">Masculino</label>
												<input id="genero" type="radio" name="genero" value="Mujer" <?= ($alum_view['alum_genero']==0?' checked':'') ?> />
													<label for="" style="margin-right: 50px">Femenino</label>
											</label>
										</div>
										<div class="form-group col-md-6">
										...
										<div class="form-group col-md-6">
											<label for="lbl_tipo">&nbsp;<br/>
												<input id="alum_tiene_discapacidad" class="form-control" name="alum_tiene_discapacidad" type="checkbox"   <?= ($alum_view['alum_tiene_discapacidad']==1 ? 'checked':'');?>  onclick="ActivarDesactivarText('alum_tiene_discapacidad','alum_discapacidad')" />
...
<div class="modal fade" 
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div id="div_documentos">
					<div class="form-group col-md-6" style='font-size:small;'>
						<table width="100%" cellspacing="0" cellpadding="0" border="0">
							<tr>
								<td style="padding-top: 15px">
