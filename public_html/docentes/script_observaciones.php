...
switch($opc){
	case 'obs_add':
        ...
        /*Código del usuario que ingresa la observación*/
		$usua_codi=(string)$_SESSION['prof_codi'];
        /*D: Docente*/
        $usua_tipo='D';
		
		$params_opc=array($alum_curs_para_codi,$usua_tipo,$usua_codi,$tipo_obs,$obs_deta);
		...
		if( $stmp_opc === false){
    		...
    		if ($veri>0)
    		{
                ...
                $detalle.=" Profesor código: ".$usua_codi;
                ...
                try {
                        ...
                        $mail->Subject = 'Observación ingresada desde Educalinks ';
	...
	case 'obs_view':
        ...
        <table class="table_striped">
            <thead>
                <tr>
                	<th colspan="4" class="center">Observaciones Ingresadas
                    </th>
                </tr>
                <tr>
