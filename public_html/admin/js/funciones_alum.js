...
/////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////
function reload_add_alum(data,tab){
	var div ="alumnos_add_panel";
	...
	if (window.XMLHttpRequest)
        ...
        xmlhttp.open("POST",'alumnos_add_script.php',true);
        xmlhttp.setRequestHeader('Content-Type','application/x-www-form-urlencoded');
        xmlhttp.send(data);    
    }
        ...
        {   if (xmlhttp.readyState==4 && xmlhttp.status==200)
        	{   if ( xmlhttp.responseText > 0 )
        		{   document.getElementById(elem).value=xmlhttp.responseText;
                    ...
                    // $('#btn_inscribir').hide();
                    // $('#btn_cancelar').hide();
                    var current_tab = $("div[class='tab-pane active']").attr('id');
                    reload_add_alum('alum_codi='+xmlhttp.responseText,current_tab);
