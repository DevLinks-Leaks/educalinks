			...
			try
			{
				...
				if ($_POST['tabla']=='representantes')
				{
					...
					for ($i=2; $i<=$filas; $i++)
					{
						...
						$representante->setAttribute('repr_migr_codi',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(0, $i)->getValue())));
						$representante->setAttribute('repr_cedula',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(1, $i)->getValue())));
						$representante->setAttribute('repr_tipoidfactura',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(2, $i)->getValue())));
						...
						$representante->setAttribute('idestadocivil',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(9, $i)->getValue())));
						...
						$representante->setAttribute('repr_lugar_trabajo',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(16, $i)->getValue())));
						$representante->setAttribute('repr_direc_trabajo',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(17, $i)->getValue())));
						$representante->setAttribute('repr_telf_trab',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(18, $i)->getValue())));
						$representante->setAttribute('repr_cargo',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(19, $i)->getValue())));
						$representante->setAttribute('idreligion',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(20, $i)->getValue())));
						$representante->setAttribute('repr_estudios',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(21, $i)->getValue())));
						...
						$representante->setAttribute('repr_ex_alum',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(24, $i)->getValue())));
						$representante->setAttribute('repr_motivo_representa',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(25, $i)->getValue())));
						$representante->setAttribute('repr_escolaborador',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(26, $i)->getValue())));
				...
				if ($_POST['tabla']=='alum_repr')
				{
					...
					for ($i=2; $i<=$filas; $i++)
					{
						...
						$alum_repr->setAttribute('alum_migr_codi',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(0, $i)->getValue())));
						$alum_repr->setAttribute('repr_migr_codi',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(1, $i)->getValue())));
						$alum_repr->setAttribute('repre_alum_fact',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(2, $i)->getValue())));
						$alum_repr->setAttribute('repre_alum_princ',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(3, $i)->getValue())));
						$alum_repr->setAttribute('idparentesco',rtrim(ltrim($objPHPExcel->getActiveSheet()->getCellByColumnAndRow(4, $i)->getValue())));
