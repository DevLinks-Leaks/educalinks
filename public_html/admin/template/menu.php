			...
			<ul class="sidebar-menu">
				...
				<li class="<? if (substr($Menu,0,1)==1) echo 'active'; ?> treeview"><!-- AQUI SERIA EL OPEN --><!--  -->
					...
					<ul class="treeview-menu">
						...
						<?php if(permiso_activo( 9))?> <li <? if($Menu==103) echo 'class="active"'; ?>><a href="alumnos_repre_main.php"><span class='fa fa-heart-o'></span> Representantes</a></li>
				...
				<li class="<? if (substr($Menu,0,1)==2) echo 'active'; ?> treeview"><!-- AQUI SERIA EL OPEN --><!--  -->
					...
					<ul class="treeview-menu">
						<?php if(permiso_activo(10))?> <li <? if($Menu==201) echo 'class="active"'; ?>><a href="cursos_paralelo_main.php"><span class='fa fa-university'></span> Cursos Paralelo</a></li>
						<?php if(permiso_activo(11))?> <li <? if($Menu==202) echo 'class="active"'; ?>><a href="cursos_notas_permisos_main.php"><span class='fa fa-list-alt'></span> Notas Permisos</a></li>
