			...
			<ul class="sidebar-menu">
				...
				<li class="<? if (substr($Menu,0,1)==1) echo 'active'; ?> treeview"><!-- AQUI SERIA EL OPEN --><!--  -->
					...
					<ul class="treeview-menu">
						<?php if(permiso_activo( 7))?> <li <? if($Menu==101) echo 'class="active"'; ?>><a href="alumnos_add.php" title='Formulario para registrar un alumno nuevo'><span class='fa fa-clipboard'></span> Nuevo Alumno </a></li>
						<?php if(permiso_activo( 8))?> <li <? if($Menu==102) echo 'class="active"'; ?>><a href="alumnos_main.php" title='Bandeja principal de todos los alumnos'><span class='fa fa-graduation-cap'></span> Lista Alumnos</a></li>
						<?php if(permiso_activo( 9))?> <li <? if($Menu==103) echo 'class="active"'; ?>><a href="alumnos_repre_main.php" title='Bandeja principal de todos los representantes'><span class='fa fa-heart-o'></span> Lista Representantes</a></li>
						<?php if(permiso_activo(527))?><li <? if($Menu==106) echo 'class="active"'; ?>><a href="alumnos_blacklist_main.php" title='Listado de alumnos en Blacllist'><span class='fa fa-list'></span> Lista de Blacklist</a></li>
				...
				<li class="<? if (substr($Menu,0,1)==9) echo 'active'; ?> treeview"><!-- AQUI SERIA EL OPEN --><!--  -->
					<a href="#"><i class="fa fa-briefcase"></i> <span>Profesores</span> <i class="fa fa-angle-left pull-right"></i></a>
					<ul class="treeview-menu">
						<?php if(permiso_activo(67))?> <li <? if($Menu==901) echo 'class="active"'; ?>><a href="profesores_main.php"><span class='fa fa-briefcase'></span> Lista de profesores</a></li>
						<?php if(permiso_activo(11))?> <li <? if($Menu==902) echo 'class="active"'; ?>><a href="cursos_notas_permisos_main.php" title='Permisos de ingresos de notas a docentes.'><span class='fa fa-lock'></span> Permiso ingreso notas</a></li>
					</ul>
				</li>
				<?php }?>
