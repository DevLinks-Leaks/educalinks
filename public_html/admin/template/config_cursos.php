								 <div class="box-tools pull-right">
									<div class="btn-group">
										...
										<i class="fa fa-wrench"></i> Configuración</button>
									...
									<div class="btn-group">
										<button type="button" class="btn btn-box-tool dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
										<i class="fa fa-search"></i> Ver</button>
										<ul class="dropdown-menu" role="menu">
									...
									<button type="button" class="btn btn-box-tool dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-cog"></i> Parámetros</button>
								</div>