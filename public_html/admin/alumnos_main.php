									...
									<div id="tbl_search" class="form-horizontal" role="form">
										...
										<div id='div_opc_adv' name='div_opc_adv' class='collapse'>
											...
											<div class='row'>
												<div class='col-md-6 col-sm-12'>
													<div class='form-group'>
														<label class="col-md-4 col-sm-3 control-label" style='text-align: right;' for='curso'>Curso:</label>
														<div id='div_cmb_curso' class="col-md-8 col-sm-8" >
															<select class="form-control input-sm"  id="curso" name="cursos">
																<option value="-1">- Todos -</option>
																<?
								...
								<h3 class="box-title">Bandeja de alumnos</h3>
								 <div class="box-tools pull-right">
									...
									<div class="btn-group hidden-sm hidden-xs">
										...
										<li><a href="#" onclick="BuscarAlumnos_complete(3);"><i class='fa fa-print'></i> Mostrar cuadrícula para impresión</a></li>
										</ul>
									</div>
								</div>
