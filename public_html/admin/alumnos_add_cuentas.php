...
<div class="col-md-12">
	<table id="tbl_metodo_pago" class="table table-striped hover">
		...
		<tr>
			...
			<td class="roworder" style="cursor: move;"><?=($row_alum_cuentas_view['alum_cuen_estado']=='A' ? 'Aprobado' : 'Pendiente')?></td>
			<td class="text-right">
				<div class="btn-group btn-group-sm" role="group">
					<? if($row_alum_cuentas_view['alum_cuen_estado']=='P'){?>
					<a class="btn btn-success" onmouseover="$(this).tooltip('show')" title="Aprobar Método de Pago" href="javascript:cuentas_apro('opc=alum_cuen_apro&alum_cuen_codi=<?=$row_alum_cuentas_view['alum_cuen_codi'];?>&alum_codi=<?=$row_alum_cuentas_view['alum_codi'];?>&alum_cuen_banc_tarj=<?=$row_alum_cuentas_view['banc_tarj'];?>','<?=$alum_codi?>');" >
                    ...
                    <a class="btn btn-danger" onmouseover="$(this).tooltip('show')" title="Eliminar Método de Pago" href="javascript:cuentas_del('opc=alum_cuen_del&alum_cuen_codi=<?=$row_alum_cuentas_view['alum_cuen_codi'];?>&alum_codi=<?=$row_alum_cuentas_view['alum_codi'];?>&alum_cuen_banc_tarj=<?=$row_alum_cuentas_view['banc_tarj'];?>','<?=$alum_codi?>');" >
