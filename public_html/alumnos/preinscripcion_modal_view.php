...
<div class="modal-header">
	...
	<h4 class="modal-title" id="title_repr">Representante: <?=$row_repr_info['repr_apel'].' '.$row_repr_info['repr_nomb']?></h4>
</div>
<div id="modal_repr" class="modal-body" >
	<div class="row">
		<div id="tabs" name="tabs" class="col-md-12 nav-tabs-custom">
			<ul class="nav nav-tabs">    
				<li class="active"><a href="#tab_1" data-toggle="tab" onClick=""><span class="fa fa-clipboard"></span> Datos Personales</a></li>
				<li><a href="#tab_2" data-toggle="tab" onClick="" ><span class="fa fa-phone"></span> Datos Contacto</a></li>
				<li><a href="#tab_3" data-toggle="tab" onClick=""><span class="fa fa-graduation-cap"></span> Trabajo y Estudio</a></li>
				<li><a href="#tab_4" data-toggle="tab" onClick=""><span class="fa fa-archive"></span> Otros Datos</a></li>
			</ul>
			<div class="tab-content">
				<div class="row tab-pane active" id="tab_1" name="tab_1">
					<div class="col-md-6">
				...
				<div class="row tab-pane" id="tab_2" name="tab_2">
					<div class="col-md-6">
						<div class="form-group">
				...
				<div class="row tab-pane" id="tab_3" name="tab_3">
					<div class="col-md-6">
						<div class="form-group">
				...
				<div class="row tab-pane" id="tab_4" name="tab_4">
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
