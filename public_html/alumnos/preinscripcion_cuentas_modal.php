	...
	<div class="row">
		...
		<div class="form-group col-md-6">
			<label for="alum_cuen_banc_tarj" id="lbl_banco_tarjeta">Banco/Tarjeta:</label>
				...
				echo '<select class="form-control input-sm" id="alum_cuen_banc_tarj" name="alum_cuen_banc_tarj[]" '.$deshabilitado.'>';
				echo '<option value="">SELECCIONE</option>';
...
<div class="modal-footer">
	<button id="btn_guardar_cuen" type='button' class='btn btn-success' data-loading="Guardando..."  onclick="cuenta_add('script_preinscripcion.php',<?=$_SESSION['alum_codi']?>);" >Guardar</button>
	<button 
		type="button" 
