	<aside class="main-sidebar">
        ...
        <section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<? } ?>
				<? if ($_SESSION['directorio']=='moderna' or $_SESSION['directorio']=='dev' ){?><li class="<? if ($Menu==10) echo 'active'; ?>"><a href="actualizacion_datos.php"><i class="fa fa-clipboard"></i> <span>Datos</span></a></li><?}?>
