...
const MODULO = 'modulos/finan/convenio_pago/';
const HTML_FILES="finan/convenio_pago/convenio_pago_";
# controladores
const RESEND_TO_SRI = 'resend_to_sri';
const SET_PAGO = 'set_pago';
const SEND_TO_SRI_ALL = 'send_to_sri_all';

const SEND_DEUDA_CP_ALL = 'send_deuda_cp_all';
...
const VIEW_BADGE_CP = 'badge_gest_cp';
