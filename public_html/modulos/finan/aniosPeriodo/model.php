...
class AnioPeriodo extends DBAbstractModel{
	...
	{   if (array_key_exists('anio',$data))
		{   foreach($data as $campo=>$valor)
            ...
            $this->parametros = array($anio, $producto, $fechaInicio, $diasProntopago, $fechaFin, $codigoUsuario);
           	var_dump($data);
	...
	{   foreach ($data as $campo=>$valor)
        ...
        $this->parametros = array($anio, $producto, $fechaInicio, $diasProntopago, $fechaFin, $ckb_deudasPendientes);
