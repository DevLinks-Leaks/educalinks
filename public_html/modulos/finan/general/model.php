...
class General extends DBAbstractModel{
	...
	{	if (array_key_exists('nombres',$filtros))
		{	if ( !isset( $filtros['tipo_persona'] ) || ( $filtros['tipo_persona'] == NULL ) )
				$tipo_persona = 1;
			else
				$tipo_persona = $filtros['tipo_persona'];
			
			$this->parametros = array( 'nombres', $filtros['nombres'], $tipo_persona );
        }
		else
		{	if ( !isset( $filtros['tipo_persona'] ) || ( $filtros['tipo_persona'] == NULL ) )
				$tipo_persona = 1;
			...
			$this->parametros = array( 'numeroIdentificacion', $filtros['numeroIdentificacion'], $tipo_persona );
        }
