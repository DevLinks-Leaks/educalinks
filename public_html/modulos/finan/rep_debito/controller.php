...
function handler()
{
    ...
    switch ($event)
	{
		...
		case PRINTREP_DEUDORES_XLS: //IMPRIME EL REPORTE EN XLS
			...
			->setTitle("Reporte de debito")
			->setSubject("Reporte de debito")
			->setDescription("Reporte de debito");
			//Escala de impresión
			...
			$objPHPExcel->setActiveSheetIndex(0)->setCellValueByColumnAndRow( 0, 1, 'Reporte de debito' );
			...
			$objPHPExcel->getActiveSheet()->setTitle('Reporte de debito');
			$objPHPExcel->setActiveSheetIndex(0);
			
			header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
			header('Content-Disposition: attachment;filename="reporte_de_debito.xlsx"');
			...
			exit;
			break;
		case PRINTREP_CTAS_ANTIGUAS_XLS: //IMPRIME EL REPORTE EN XLS
			$hoy = getdate();
			require_once('../../../includes/common/PHPExcel/Classes/PHPExcel.php');
			$objPHPExcel = new PHPExcel();
			$objPHPExcel->getProperties()
			...
			$reportes->get_deudores_ctas_inliquidas_report( $user_data['peri_codi'] );
			$pensiones->get_header_mediacion( );
			$test=$pensiones->rows;
			$tranx = $reportes->rows;
			...
			header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
			header('Content-Disposition: attachment;filename="reporte_de_ctas_sin_liquidez.xlsx"');
			header('Cache-Control: max-age=0');
