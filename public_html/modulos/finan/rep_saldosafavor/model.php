...
class Rep_saldosafavor extends DBAbstractModel{
    #propiedades
    public $banc_nombre;
	...
	public function get_reportesaldosafavor($peri_codi=10,$niveEcon_codigo=0,$curs_para_codi=0){
        ...
        if (count($this->rows)>0){
            $this->mensaje="Registro(s) de persona(s) con saldo a favor encontrado(s)";
        }else{
            $this->mensaje="Registro(s) de persona(s) con saldo a favor NO encontrado(s)";
        }
    }
    /*
