...
function handler() {
	...
	{	case MAIN:
            ...
            global $diccionario;
			$periodo_activo = new General();
			$periodo_activo->periodo_activo();
			$_SESSION['peri_codi'] = $periodo_activo->peri_codi;
			...
			*/
			...
			if(count($general->rows)>1){
				...
				$general->get_bandejas_act(  );
				$_SESSION['menu_bandejas_act'] = $general->bandejas_act;
				...
				$_SESSION['ruta_documentos_fotos'] = $ruta_documentos_fotos;
				switch($domain){
		...
		case INDEX:
			...
			global $diccionario;
			$periodo -> get_all_selectFormat( 'A' );
