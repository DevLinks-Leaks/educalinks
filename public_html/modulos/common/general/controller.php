	...
	{	case MAIN:
			...
			if(count($general->rows)>1){
				...
				'{combo_periodo}' => array(	"elemento"  => "combo", 
                                            ...
                                            "onChange"=>"cargaNivelesEconomicos('resultadoNivelEcon','".$diccionario['rutas_head']['ruta_html']."/general/controller.php');"),
				...
				'{combo_cursos}' => array("elemento"  => "combo", 
													  ...
													  "onChange"=>"cargaDeudores('resultado','".$diccionario['rutas_head']['ruta_html']."/general/controller.php')"),
													  "selected"  => -1)
				);
				$niveles = new General();
				...
				$data['{combo_nivel}']	= array(	
											...
											"options"   => 	array(	"name"=>"cmb_nivelesEconomicos",
																	...
																	"required"=>"required",
																	"class"=>"form-control",
																	"onChange"	=>	"cargaCursosPorNivelEconomico('resultadoCursos','".$diccionario['rutas_head']['ruta_html']."/general/controller.php')"));
        ...
        case TOGGLE_FULLSCREEN:
			if ( $user_data['toggle'] == 'true')
				$_SESSION['toggle_fullscreen'] ='true';
			else
				$_SESSION['toggle_fullscreen'] ='false';
			echo $_SESSION['toggle_fullscreen'];
			break;
        default:
			$_SESSION['IN']="KO";
