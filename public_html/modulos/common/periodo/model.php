...
class Periodo extends DBAbstractModel{
	...
	public function get_all( $tipo = 'zzz' ) /* R = Regular, V = Vacacional, A = Admisiones */
	{   if( $tipo == '')
			$tipo = 'zzz';
		
		$this->parametros = array( $tipo );
	...
	public function get_all_selectFormat( $tipo = 'zzz' )
	{	if( $tipo == '')
			$tipo = 'zzz';
	...
	public function periodo_activo_admisiones()
