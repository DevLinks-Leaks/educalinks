...
class facturasAutorizadas extends DB_Abstract_mobile
{
	...
	public function Facturas($estadoElectronico, $fechaemision_ini,$fechaemision_fin, $cod_titular, $id_titular)
	{
        $this->parametros = array($estadoElectronico, $fechaemision_ini,$fechaemision_fin, $cod_titular, $id_titular);
