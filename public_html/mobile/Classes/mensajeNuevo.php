...
class mensajeNuevo extends DB_Abstract_mobile
{
	...
	public function addMessage($mens_de,$mens_de_tipo,$mens_para,$mens_para_tipo,$mens_titu,$mens_deta)
	{
        $this->parametros = array($mens_de,$mens_de_tipo,$mens_para,$mens_para_tipo,$mens_titu,$mens_deta);
        $this->sp = "mens_add";
