		...
		<table class="table table-striped table-bordered">
			...
			<?php while($row_mater_view = sqlsrv_fetch_array($stmp_mater)){?>
				<tr>
					...
					<td><div><a class="btn btn-default " href="<?= $_SESSION['ruta_materiales_carga'].$row_mater_view['mater_file'];?>" ><span class="fa fa-download"></span> Descargar</a></div>
                    <div><a class="btn btn-default btn_opc_lista_eliminar" href="javascript:elimina_materiales('div_materiales','script_materiales.php','<?= $row_mater_view['mater_codi'];?>','<?=$_POST['curs_para_mate_prof_codi']?>')" ><span class="fa fa-trash btn_opc_lista_eliminar"></span>  Eliminar</a></div></td>
				</tr>
			<?php }?>
			</tbody>
		</table>
