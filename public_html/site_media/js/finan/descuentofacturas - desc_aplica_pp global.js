...
{   document.getElementById(div).innerHTML='<br><div align="center" style="height:100%;"><i style="font-size:large;color:darkred;" class="fa fa-cog fa-spin"></i></div>';
    ...
    xhr.onreadystatechange=function(){
        ...
        {   document.getElementById(div).innerHTML=xhr.responseText;
            ...
            document.getElementById( 'span_button_return' ).innerHTML='<button class="btn btn-info" type="button" ' +
...
{   var i = 1;
	$('#tabla_descuentos_cliente tbody tr').each(function(){
        ...
        {   $(this).find('td').eq(0).css("text-decoration", "none");
            ...
            $(this).find('td').eq(3).html(    "<span onclick='js_descuentofactura_del_descuento_asignado(\"" + codigo + "\")' " +
...
{   var i = 1;
	$('#tabla_descuentos_cliente tbody tr').each(function(){
        ...
        {   $(this).find('td').eq(0).css("text-decoration", "line-through");
            ...
            $(this).find('td').eq(3).html(  "<span onclick='js_descuentofactura_deshacer_del_descuento_asignado(\"" + codigo + "\")' " +
    ...
    {   if(porcentaje_descto <= 100 && porcentaje_descto > 0)
        {   $('#tabla_descuentos_cliente tbody tr').each(function(){
            ...
            {   nuevaLinea +="<td " + style + " data-codigo='" + codigo_descto + "' data-estado='active'>" + descripcion + "</td>";
				...
				//if ( ckb_prontopago && $('#span_desc_aplica_pp').hasClass('fa-square-o') )
				//	$('#span_desc_aplica_pp').removeClass('fa-square-o').addClass('fa-check-square-o');
				if ( !ckb_prontopago && $('#span_desc_aplica_pp').hasClass('fa-check-square-o') )
				    $('#span_desc_aplica_pp').removeClass('fa-check-square-o').addClass('fa-square-o');
				
				//document.getElementById( "ckb_general_aplicaprontopago" ).checked = ckb_prontopago;
                //js_descuentofactura_descuentos_select_all2 ( document.getElementById( "ckb_general_aplicaprontopago" ) );
            }
            else
...
{   var factura = {
    ...
    $('#tabla_descuentos_cliente tbody tr').each(function(){
        ...
        {   factura.descuento.push({
				...
				aplica_pp     : ( ( $("#span_desc_aplica_pp" ).hasClass('fa-check-square-o') ) ? 1 : 0 )
                //aplica_pp     : ( ( document.getElementById("ckb_general_aplicaprontopago" ).checked) ? 1 : 0 )
            ...
            {   var resultado = js_general_resultado_sql(xhr.responseText);
                ...
                var mensaje = '<div class="callout callout-' + class_callout + '">'
                            ...
                            + '<div class="row">'+
                                ...
                                '</div>'+
                                '<div class="col-md-6" style="text-align:center">'+
                                    '<button class="btn btn-success" data-dismiss="modal">Continuar modificando</button>'+
                                '</div>'+
                            '</div>';
...
function js_descuentofactura_descuentos_select_all ( )
{   if ( $('#span_desc_aplica_pp').hasClass('fa-square-o') )
		$('#span_desc_aplica_pp').removeClass('fa-square-o').addClass('fa-check-square-o')
	else
		$('#span_desc_aplica_pp').removeClass('fa-check-square-o').addClass('fa-square-o')
}
function js_descuentofactura_descuentos_select_all2 ( source )
{   var i = 0;
	$('#tabla_descuentos_cliente tbody tr').each(function(){
		i++;
		document.getElementById( 'ckb_dapp_' + i ).checked = source.checked;
	});
}