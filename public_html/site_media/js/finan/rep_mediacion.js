...
function js_rep_mediacion_carga_reports_deudores( div, url, evento ) //PDF DE LA TABLA PRINCIPAL CON TOTALES VERTICALES Y HORIZONTALES
{   "use strict";
    var doit = 'yes';
	console.log(doit);
    if( doit === 'yes' )
...
function js_rep_mediacion_check_fecha()
{   "use strict";
