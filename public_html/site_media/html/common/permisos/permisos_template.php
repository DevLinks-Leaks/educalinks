...
<link rel="stylesheet" type="text/css" media="screen" href="{ruta_includes_common}/bootstrap/css/datatable-bootstrap.css">
...
<script src="{ruta_js}/finan/puntos_emision.js"></script>
<script src="{ruta_js_finan}/general.js"></script>
<script type="text/javascript" src="{ruta_includes_common}/bootstrap/js/datatable.js"></script>
</head>
<body>
  {navbar}
