...
<head>
    ...
    <!-- fullCalendar 2.2.5-->
    <link rel="stylesheet" href="{ruta_includes_common}/plugins/fullcalendar/fullcalendar.min.css">
    <link rel="stylesheet" href="{ruta_includes_common}/plugins/fullcalendar/fullcalendar.print.css" media="print">
    <!-- Theme style -->
    ...
    <div class="wrapper">
		...
		<div class="content-wrapper">
			<section class="content-header">
				...
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-home"></i> Usuario</a></li>
					<li class="active">{subtitulo}</li>
				</ol>
			</section>
			<section id='formulario' name='formulario' class="content">
				{formulario}
			</section>
			{menu_sidebar}
		</div>
