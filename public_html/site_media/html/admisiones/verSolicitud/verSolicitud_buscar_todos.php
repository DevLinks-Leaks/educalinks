					...
					<div class="grid" id='div_grid_modal_asign_fecha' name='div_grid_modal_asign_fecha'>
						...
						<div class="row">
							...
							<div class='col-sm-8' style='text-align:left;'>
								<input type="text" id="txt_fecha_asign_1" class="form-control" name="txt_fecha_asign_1" value="">
							</div>
						</div>
						<div class="row">
							<div class='col-sm-12'>
						...
						<div class="row">
							<div class='col-sm-4' style='text-align:left;'>
								<label for="txt_fecha_asign_1" class="control-label">Actividad/Examen</label>
							</div>
							<div class='col-sm-8' style='text-align:left;'>
