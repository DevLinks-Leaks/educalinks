			...
			<div class="col-md-12">
				...
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs pull-right">
						<li id='li_5' {list_enviar_display}><a><i class="fa fa-send"></i><span class="hidden-xs hidden-sm"> ENVIAR SOLICITUD</span></a></li>
						<li id='li_4'><a onclick="return js_docAdmin_get_documentos_periodo_actual('div_documentos_admisiones', '{ruta_html_admisiones}/documentos_admision/controller.php');"><i class="fa fa-file"></i><span class="hidden-xs hidden-sm"> DOCUMENTOS</span></a></li>
						<li id='li_3'><a onclick="return js_representantes_get_representantes(document.getElementById('hd_per_codi').value, 'div_representantes_principales', '{ruta_html_common}/representantes/controller.php', 'off');"><i class="fa fa-black-tie"></i><span class="hidden-xs hidden-sm"> REPR. PRINCIPALES</span></a></li>
						<li id='li_2'><a><i class="fa fa-group"></i><span class="hidden-xs hidden-sm"> REPRESENTANTE</span></a></li>
						<li id='li_1' class="active"><a><i class="fa fa-user"></i><span class="hidden-xs hidden-sm"> DATOS PERSONALES DEL POSTULANTE</span></a></li>
						<!--<li class="pull-left header"><i class="fa fa-th"></i> Formulario de solicitud de admisión</li>-->
					</ul>
					<div class="tab-content">
						<div class="tab-pane active" id="tab_1">
							<h4 class="box-title">PARTE 1: DATOS PERSONALES DEL POSTULANTE</h4>
										...
										<div id="div_per_postulante" name="div_per_postulante" class="box-body">
											<div class='grid'>  
												<div> 
														...
														<div class='col-sm-4'>
															<div class='box'>
																<div class='box-body'>
																	...
																	<div class='row'>
																		<div class='col-sm-12' style='text-align:center;'>
																			<p align="center"><input type="file" name="per_soli_foto" id="per_soli_foto" required="required"></p>
																		</div>
																	</div>
																</div>
															</div>
														...
														<div class='col-sm-8'>
															<div class='row'>
																...
																<div class="col-sm-6 error">
																	...
																	onchange="vali_identificacion('{ruta_html_admisiones}/enviarSolicitud/controller.php',$('#cmb_per_tipo_identificacion').val(),this.value,'msg_validar_cedula');"
																			maxlength="20" />
																	<span id='msg_validar_cedula' name='msg_validar_cedula'></span>
																</div>
															</div>
															<div class="row">
																<div class="col-sm-12">
															...
															<div class='row'>
																...
																<div class="col-sm-6 error">
																	...
																	<input name="per_email_personal" id="per_email_personal"  type="text" class="form-control" 
																		value="{per_email_personal}" onchange="vali_email('{ruta_html_admisiones}/enviarSolicitud/controller.php',this.value,'msg_validar_correo');"
																		maxlength="50" placeholder="Correo electrónico personal"/>
																	<span id='msg_validar_correo' name='msg_validar_correo'></span>
																</div>
															</div>
														</div>
													</div>
													...
													<div class='row'>
														...
														<div class="col-sm-3 error">
															<label>Teléfono (*)</label><input name="per_telf" id="per_telf" type="text" class="form-control" value="{per_telf}" placeholder="Teléfono"
																maxlength="25" onchange="vali_esnumerico('{ruta_html_admisiones}/enviarSolicitud/controller.php',this.value,'msg_validar_telf_alum');"/>
															 <span id='msg_validar_telf_alum' name='msg_validar_telf_alum'></span>
														</div>
														<div class="col-sm-2">
															<label>Sector</label>
															...
															<div class="checkbox">
																<label>
																	<input type="checkbox" id="ckb_matriculado_anteriormente" name="ckb_matriculado_anteriormente"
																		...
																		¿El aspirante ha sido alumno de la Institución antes?
																</label>
															</div>
														</div>
													</div>
															...
															<div class="checkbox">
																<label>
																	<input type="checkbox" id="ckb_pruebas_psicologicas" name="ckb_pruebas_psicologicas"
																		...
																		¿El aspirante ha requerido de pruebas psicológicas previamente?
																</label>
															</div>
														</div>
													</div>
													...
													<div class='row'>
														<div class="col-sm-12"><label>¿Cómo se enteró que había iniciado el proceso de pre-admisión? </label>
														<!--<textarea id='per_como_se_entero' name='per_como_se_entero' class="form-control" 
															placeholder="Indique como se enteró del proceso de pre-admisión">{per_como_se_entero}</textarea> -->
															<select id='per_como_se_entero' name='per_como_se_entero' class="form-control">
																...
																<option value="PRENSA ESCRITA/RADIO" {opc_5}>PRENSA ESCRITA/RADIO</option>
															</select>
														</div>
													</div>
												</div>
								...
								<div class="grid">
									...
									<div class="row">
										<div class="col-md-12 pull-left">
											...
											<a id="btn_tab_1_next_button" name="btn_tab_1_next_button"  class="btn btn-app" data-toggle="tab"
												onclick="return validarFormAspirante('{ruta_html_admisiones}');">
												<i class="fa fa-arrow-circle-o-right"></i> Siguiente
											</a>
										</div>
									</div>
						...
						<div class="tab-pane" id="tab_2">
							<h4 class="box-title">PARTE 2: DATOS DEL REPRESENTANTE/GUARDI&Aacute;N</h4>
							<div class="grid">
								<div class="box-body">
										...
										<div class="panel box box-primary">
											<div class="box-header with-border">
												<h4 class="box-title">
													...
													DATOS DEL PADRE (Haga click para expandir u ocultar)
													</a>
												</h4>
											</div>
														...
														<div>
															<div class='row'>
																...
																<div class="col-sm-6 error">
																	...
																	placeholder="No. de identificaci&oacute;n"
																	maxlength="20"
																	onchange="vali_identificacion('{ruta_html_admisiones}/enviarSolicitud/controller.php',$('#cmb_repr1_tipo_identificacion').val(),this.value,'msg_validar_cedula_repr1');"/>
																	<span id='msg_validar_cedula_repr1' name='msg_validar_cedula_repr1'></span>
																</div>
															</div>
															<div class='row'>
																<div class="col-sm-12">
															...
															<div class='row'>
																...
																<div class="col-sm-5 error">
																	...
																	maxlength="25" onchange="vali_esnumerico('{ruta_html_admisiones}/enviarSolicitud/controller.php',this.value,'msg_validar_telf_repr1');"/>
																	<span id='msg_validar_telf_repr1' name='msg_validar_telf_repr1'></span>
																</div>
															</div>
															<div class='row'>
																<div class="col-sm-12">
															...
															<div class='row'>
																...
																<div class="col-sm-5 error">
																	...
																	<input name="repr1_email_personal" id="repr1_email_personal"  type="text" class="form-control" value="{repr1_email_personal}" 
																		...
																		onchange="vali_email('{ruta_html_admisiones}/enviarSolicitud/controller.php',this.value,'msg_validar_correo_repr1');" />
																	<span id='msg_validar_correo_repr1' name='msg_validar_correo_repr1'></span>
																</div>
															</div>
															<div class='row'>
																<div class="col-sm-12">
															...
															<div class='row'>
																<div class="col-sm-2 error">
																	<label>Fecha de nacimiento (*) </label>
																	<input name="repr1_fecha_nac" id="repr1_fecha_nac"  type="text" class="form-control" value="{repr1_fecha_nac}" />
																</div>
																<div class="col-sm-4">
																	<label>Pais</label>
															...
															<div class='row'>
																...
																<div class="col-sm-4">
																	...
																	<input name="repr1_empr_telf" id="repr1_empr_telf"  type="text" class="form-control" value="{repr1_empr_telf}" 
																		placeholder="Teléfono" onchange="vali_esnumerico('{ruta_html_admisiones}/enviarSolicitud/controller.php',this.value,'msg_validar_telf_lab_repr1');"/>
																	<span id='msg_validar_telf_lab_repr1' name='msg_validar_telf_lab_repr1'></span>
																</div>
																<div class="col-sm-4">
																	...
																	<input name="repr1_empr_mail" id="repr1_empr_mail"  type="text" class="form-control" value="{repr1_empr_mail}" 
																		...
																		onchange="vali_email('{ruta_html_admisiones}/enviarSolicitud/controller.php',this.value,'msg_validar_correo_lab_repr1');" />
																	<span id='msg_validar_correo_lab_repr1' name='msg_validar_correo_lab_repr1'></span>
																</div>
															</div>
															<div class='row'>
																<div class="col-sm-12">
									...
									<div class="panel box box-warning">
										<div class="box-header with-border">
											<h4 class="box-title">
												...
												DATOS DE LA MADRE (Haga click para expandir u ocultar)
												</a>
											</h4>
										</div>
													...
													<div>
														<div class='row'>
															...
															<div class="col-sm-6">
																...
																maxlength="20"
																onchange="vali_identificacion('{ruta_html_admisiones}/enviarSolicitud/controller.php',$('#cmb_repr2_tipo_identificacion').val(),this.value,'msg_validar_cedula_repr2');"/>
																<span id='msg_validar_cedula_repr2' name='msg_validar_cedula_repr2'></span>
															</div>
														</div>
														<div class='row'>
															<div class="col-sm-12">
														...
														<div class='row'>
															...
															<div class="col-sm-5">
																...
																onchange="vali_esnumerico('{ruta_html_admisiones}/enviarSolicitud/controller.php',this.value,'msg_validar_telf_repr2');" 
																maxlength="25"/>
																<span id='msg_validar_telf_repr2' name='msg_validar_telf_repr2'></span>
															</div>
														</div>
														<div class='row'>
															<div class="col-sm-12">
														...
														<div class='row'>
															...
															<div class="col-sm-5">
																...
																<input name="repr2_email_personal" id="repr2_email_personal"  type="text" class="form-control" value="{repr2_email_personal}" 
																	maxlength="200"placeholder="Correo electrónico personal"
																	onchange="vali_email('{ruta_html_admisiones}/enviarSolicitud/controller.php',this.value,'msg_validar_correo_repr2');" />
																	<span id='msg_validar_correo_repr2' name='msg_validar_correo_repr2'></span>
															</div>
														</div>
														<div class='row'>
															<div class="col-sm-12">
														...
														<div class='row'>
															<div class="col-sm-2">
																<label>Fecha de nacimiento </label>
																<input name="repr2_fecha_nac" id="repr2_fecha_nac"  type="text" class="form-control" value="{repr2_fecha_nac}" />
															</div>
															<div class="col-sm-4">
																<label>Pais</label>
														...
														<div class='row'>
															...
															<div class="col-sm-4">
																...
																<input name="repr2_empr_telf" id="repr2_empr_telf"  type="text" class="form-control" value="{repr2_empr_telf}" 
																	placeholder="Teléfono" onchange="vali_esnumerico('{ruta_html_admisiones}/enviarSolicitud/controller.php',this.value,'msg_validar_telf_lab_repr2');" 
																maxlength="25"/>
																<span id='msg_validar_telf_lab_repr2' name='msg_validar_telf_lab_repr2'></span>
															</div>
															<div class="col-sm-4">
																Correo electrónico laboral
																<input name="repr2_empr_mail" id="repr2_empr_mail"  type="text" class="form-control" value="{repr2_empr_mail}" 
																	maxlength="200"placeholder="Correo electrónico empresa"
																	onchange="vali_email('{ruta_html_admisiones}/enviarSolicitud/controller.php',this.value,'msg_validar_correo_lab_repr2');" />
																	<span id='msg_validar_correo_lab_repr2' name='msg_validar_correo_lab_repr2'></span>
															</div>
														</div>
														<div class='row'>
															<div class="col-sm-12">
										...
										<div class="box-header with-border">
											<h4 class="box-title">
												<a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">
													AGREGAR REPRESENTANTE/FAMILIAR (Haga click para expandir u ocultar)
												</a>
											</h4>
										</div>
								...
								<tbody>
									<tr class='row'>
										<td colspan="17">
											...
											<a id="btn_tab_2_next" name="btn_tab_2_next" data-toggle="tab" class="btn btn-app"
												onclick="return validarFormRepresentante ('{ruta_html_admisiones}', '{ruta_html_common}');">
												<i class="fa fa-arrow-circle-o-right"></i> Siguiente
											</a>
										</td>
									</tr>
