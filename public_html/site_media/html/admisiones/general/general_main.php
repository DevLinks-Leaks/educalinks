...
<body class="hold-transition skin-blue sidebar-mini">
				...
				<div class="row">
					<div class="col-md-12">
					  ...
					  <div class="box box-success">
						<div class="box-header with-border">
						  <h3 class="box-title">Solicitudes distribuidas por sectores</h3>
						...
						<div class="box-body">
						  <div class="chart">
							<canvas id="bar_solicitudes_por_sector" style="height:270px"></canvas>
						  </div>
						</div><!-- /.box-body -->
					  </div><!-- /.box -->
				  ...
				  <div class="row">
					<div class="col-md-6">
					  ...
					  <div class="box box-success">
						<div class="box-header with-border">
						  <h3 class="box-title">Solicitudes recibidas por mes</h3>
						  <div class="box-tools pull-right">
							<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
							<button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
						  </div>
						...
						<div class="box-body">
							<canvas id="pie_solicitudes_por_mes" style="height:250px"></canvas>
						</div><!-- /.box-body -->
					  </div><!-- /.box -->
					...
					<div class="col-md-6">
					  ...
					  <div class="box box-success">
						<div class="box-header with-border">
						  <h3 class="box-title">Solicitudes distribuidas por estado</h3>
						  <div class="box-tools pull-right">
							<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
							<button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
						  </div>
						...
						<div class="box-body">
						  <div class="chart">
							<canvas id="bar_solicitudes_por_estado" style="height:270px"></canvas>
						  </div>
						</div><!-- /.box-body -->
					  </div><!-- /.box -->
				  ...
				  <div class="row">
					<div class="col-md-6">
					  ...
					  <div class="box box-success">
						...
						<div class="box-body">
						  <div class="chart">
							<canvas id="bar_solicitudes_por_publicidad" style="height:270px"></canvas>
						  </div>
						</div><!-- /.box-body -->
					  </div><!-- /.box -->
					...
					<div class="col-md-6">
					  ...
					  <div class="box box-success">
						<div class="box-header with-border">
						  <h3 class="box-title">Solicitudes distribuidas por curso</h3>
						  <div class="box-tools pull-right">
							<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
							<button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
						  </div>
						...
						<div class="box-body">
						  <div class="chart">
							<canvas id="line_solicitudes_por_curso" style="height:270px"></canvas>
						  </div>
						</div><!-- /.box-body -->
					  </div><!-- /.box -->
	...
	<!-- ChartJS 1.0.1 -->
	<script src="{ruta_includes_common}/plugins/chartjs/Chart.min.js"></script>
