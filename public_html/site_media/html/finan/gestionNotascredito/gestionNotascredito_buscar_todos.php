			...
			<div class="form-horizontal" role="form">
						...
						<div class='form-group'>
							...
							<div class='col-md-6 col-sm-4' style='text-align:left;'>
								<button class="btn btn-primary" type="button" 
										...
										onmouseover='$(this).tooltip("show")'
										onclick="carga_busquedaFacturas('resultadoProceso','{ruta_html_finan}/gestionNotascredito/controller.php')"><span class='fa fa-search'></span></button>
								<div class="btn-group">
									<button type="button" 
				...
				<div id='div_opc_adv' name='div_opc_adv' class='collapse'>
					...
					<div class='row'>
						...
						<div class='col-md-6 col-sm-12'>
							<div class='form-group'>
								<label class="col-md-4 col-sm-3 control-label" style='text-align: right;' for='txt_ref_factura'>F. creaci&oacute;n deuda:</label>
								<div class="col-md-8 col-sm-8" id="div_fini" name="div_fini" >
									<div class="input-group" id="div_fini" name="div_fini" data-placement="top"
										 title='Fecha de creación de deuda, desde, hasta.'
										 onmouseover='$(this).tooltip("show")'>
										<span class="input-group-addon">
											<input type="checkbox" id='chk_fecha_deuda' name='chk_fecha_deuda' onclick='js_gestionNotascredito_check_fechadeuda();'>
										</span>		
										<span class="input-group-addon">
											<small>Inicio</small></span>
					...
					<div class='row'>
						...
						<div class='col-md-6 col-sm-12'>
							<div class='form-group'>
								<label class="col-md-4 col-sm-3 control-label" style='text-align: right;' for='txt_ref_factura'>F. autorizaci&oacute;n:</label>
								<div class="col-md-8 col-sm-8" id="div_fini" name="div_fini" >
									<div class="input-group" id="div_fini" name="div_fini" data-placement="top"
										 title='Fecha de autorización, desde, hasta.'
										 onmouseover='$(this).tooltip("show")'>
										<span class="input-group-addon">
											<input type="checkbox" id='chk_fecha_aut' name='chk_fecha_aut' onclick='js_gestionNotascredito_check_fechaAut();'>
										</span>		
										<span class="input-group-addon">
											<small>Inicio</small></span>
