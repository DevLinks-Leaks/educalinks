			...
			<ul class="sidebar-menu">
				...
				<li class="{open6} treeview">
					...
					<ul class="treeview-menu">
						...
						<li class="{menu606}">{VerDeudasSinFacturas}</li>
				...
				<li><a href="../../../manuales/Manual_Educalinks_financiero_2016_04_11_v041.pdf" target='_blank'>
						<i class="fa fa-info-circle"></i> <span>Manual de ayuda</span></a>
				</li>
