			...
			<div class="form-horizontal" role="form">
				<div class='form-group'>
					<div class='col-md-6 col-sm-12'>
						...
						<div class='form-group'>
							<label class="col-md-4 col-sm-3 control-label" style='text-align: right;' for='txt_ref_factura'>Tipo de comprobante:</label>
							...
							<div class='form-group'>
								...
								<div class="col-md-8 col-sm-8">
									<div class="input-group" id="div_fini" name="div_fini" data-placement="top"
										 ...
										 onmouseover='$(this).tooltip("show")'>
										<span class="input-group-addon">
											<input type="checkbox" id='chk_fecha_deuda' name='chk_fecha_deuda' onclick='js_verDocumentoAutorizado_check_fechadeuda();'>
										</span>		
										<span class="input-group-addon">
											<small>Inicio</small></span>
							...
							<div class='form-group'>
								...
								<div class="col-md-8 col-sm-8">
									<div class="input-group" id="div_fini" name="div_fini" data-placement="top"
										 ...
										 onmouseover='$(this).tooltip("show")'>
										<span class="input-group-addon">
											<input type="checkbox" id='chk_fecha_aut' name='chk_fecha_aut' onclick='js_verDocumentoAutorizado_check_fechaAut();'>
										</span>			
										<span class="input-group-addon">
											<small>Inicio</small></span>
