...
<body class="hold-transition skin-blue sidebar-mini {sidebar_status}">
    ...
    <script src="{ruta_includes_common}/dist/js/demo.js">
	
	</script><script src="{ruta_includes_common}/growl/jquery.growl.js" type="text/javascript"></script>
	...
	<script src="{ruta_js_finan}/sucursales.js"></script>
