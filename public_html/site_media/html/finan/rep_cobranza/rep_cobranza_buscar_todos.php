	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Reporte de Cobranza</h4>
			</div>
		...
		<div class="form-horizontal" role="form">
			<div class='col-md-7 col-sm-12'>
				<div class='row'>
					...
					<div class='col-md-12 col-sm-12'>
						<div class='form-group'>
							<label class="col-md-4 col-sm-3 control-label" style='text-align: right;' for='txt_nom_cliente'>Usuario:</label>
							<div class="col-md-7 col-sm-7">
								{combo_usuario}
							</div>
						</div>
			...
			<div class='col-md-5 col-sm-12' style='text-align:center;'>
				<button type="button" 
						...
						onclick=" carga_reports_cobranza_crm('modal_edit_body','{ruta_html_finan}/rep_cobranza/controller.php','print_rep_cobranza')">
