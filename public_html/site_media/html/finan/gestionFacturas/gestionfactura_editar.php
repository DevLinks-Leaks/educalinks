	<div class="modal-header" style='background-color:#E55A2F;color:white;'>
		...
		<h4 class="modal-title" id="myModalLabel">Edición de factura no. {factura}</h4>
	</div>
	<div class="modal-body">
		<div class="nav-tabs-custom">
			<ul class="nav nav-tabs" role="tablist">
				<li role="presentation" class="active"><a href="#home" 
					onclick="editar('{codigo}','{codigoAlumno}','modal_edit_body','{ruta_html_finan}/gestionFacturas/controller.php','{ruta_html_common}/representantes/controller.php',true)"
					aria-controls="home" role="tab" data-toggle="tab"><i class='fa fa-clipboard'></i> Edición de datos</a></li>
				<li role="presentation"><a href="#Reasignar" aria-controls="Reasignar" role="tab" data-toggle="tab"><i class='fa fa-heart-o'></i> Asignar representante</a></li>
			</ul>
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="home">
					<br>
					<form id='frm_pago' name='frm_pago' onsubmit="return js_gestionFactura_validaSave_edited('{ruta_html_finan}/gestionFacturas/controller.php')" role="form" data-toggle="validator">
						<div class="row">
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class='alert alert-info fade in'>
										<small>
											<table width='100%'>
												<tr><td style='vertical-align:top' colspan='2'><b>Datos del titular en la factura</b></td></tr>
