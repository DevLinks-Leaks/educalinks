...
<form id="file_form" action="{ruta_html_finan}/convenio_pago/controller.php" enctype="multipart/form-data" method="post" target="_blank">
		...
		<div class="panel-body" id="desplegable_busqueda" name="desplegable_busqueda">
			<div class="form-horizontal" role="form">
				<div class='form-group'>
					<div class='col-md-4 col-sm-12'>
						<button class="btn btn-primary fa fa-search" type="button" 
								...
								onclick="js_convenio_pago_carga_busquedaFacturas('resultadoProceso','{ruta_html_finan}/convenio_pago/controller.php')"></button>
						<div class="btn-group">
							<button type="button" 
							...
							<ul class="dropdown-menu" role="menu">
								<li><a href="#" onclick="js_convenio_pago_to_excel_busquedaFacturas('print_excel_all_data','mini');">Reporte reducido</a></li>
								<li><a href="#" onclick="js_convenio_pago_to_excel_busquedaFacturas('print_excel_all_data','completo');">Reporte completo</a></li>
							</ul>
						</div>
					</div>
					...
					<div class="checkbox checkbox-info col-sm-2">
						<label for='ckb_gestionFactura_opc_adv'>
							<input type="checkbox" id='ckb_gestionFactura_opc_adv' name='ckb_gestionFactura_opc_adv' onclick='js_convenio_pago_check_opc_avanzadas();'>
				...
				<div id='div_gestionFactura_opc_adv' name='div_gestionFactura_opc_adv' class='collapse'>
					...
					<div class='form-group'>
						...
						<div class="col-md-6 col-sm-10 col-md-offset-0 col-sm-offset-1">
							<div class="input-group" id="div_total_neto" name="div_total_neto" data-placement="top"
								 ...
								 onmouseover='$(this).tooltip("show")'>
								<span class="input-group-addon">
									<input type="checkbox" id='chk_tneto' name='chk_tneto' onclick='js_convenio_pago_check_tneto();'>
								</span>
								<span class="input-group-addon">
						...
						<div class="col-md-6 col-sm-10 col-md-offset-0 col-sm-offset-1" id="div_fini" name="div_fini" >
							<div class="input-group" id="div_fini" name="div_fini" data-placement="top"
								 ...
								 onmouseover='$(this).tooltip("show")'>
								<span class="input-group-addon">
									<input type="checkbox" id='chk_fecha_deuda' name='chk_fecha_deuda' onclick='js_convenio_pago_check_fechadeuda();'>
								</span>
								<span class="input-group-addon">
					...
					<div class='form-group'>
						...
						<div class="col-md-6 col-sm-10 col-md-offset-0 col-sm-offset-1" id="div_fini" name="div_fini" >
							<div class="input-group" id="div_fini" name="div_fini" data-placement="top"
								 ...
								 onmouseover='$(this).tooltip("show")'>
								<span class="input-group-addon">
									<input type="checkbox" id='chk_fecha_aut' name='chk_fecha_aut' onclick='js_convenio_pago_check_fechaAut();'>
								</span>
								<span class="input-group-addon">
					...
					<div class='form-group'>
						<label class="col-md-2 col-sm-3 control-label" style='text-align: right;' for='cmb_estado' ></label>
						<div class="col-md-4 col-sm-8"
								data-placement="bottom"
								title='Estado de la factura'
								onmouseover='$(this).tooltip("show")'>
							<select style="display:none;" class='form-control input-sm' id='cmb_estado' name='cmb_estado'>
	...
	<div class="box-header with-border">
		<h3 class="box-title">
			...
			<button class="btn btn-success fa fa-upload" type="button" aria-hidden='true' data-toggle='modal' data-target='#modal_lote'
					...
					onmouseover='$(this).tooltip("show")'
					onclick="js_convenio_pago_envio_facturasPorLote('modal_lote_body','{ruta_html_finan}/gestionFacturas/controller.php')" {disabled_enviar_lote}></button>
			<button class="btn btn-warning fa fa-repeat" type="button" aria-hidden='true' data-toggle='modal' data-target='#modal_lote' 
					...
					onmouseover='$(this).tooltip("show")'
					onclick="js_convenio_pago_autorizar_facturasPorLote('modal_lote_body','{ruta_html_finan}/gestionFacturas/controller.php')" {disabled_enviar_lote}></button>
