			...
			<div class="form-horizontal" role="form">
				<div class='col-md-11 col-sm-12'>
						...
						<div class='row'>
							...
							<div class='col-md-6 col-sm-12'>
								<div class='form-group'>
									<label class="col-md-4 col-sm-3 control-label" style='text-align: right;' for='txt_id_estudiante'>Id. estudiante:</label>
									<div class="col-md-8  col-sm-8"
											data-placement="bottom"
						...
						<div class='row'>
							...
							<div class='col-md-6 col-sm-12'>
								<div class='form-group'>
									<!--<label class="col-md-4 col-sm-3 control-label" style='text-align: right;' for='cmb_estado'>Estado periodo:</label>
									<div class="col-md-8  col-sm-8"
											data-placement="bottom"
											title='Estado de la factura'
											onmouseover='$(this).tooltip("show")'>
