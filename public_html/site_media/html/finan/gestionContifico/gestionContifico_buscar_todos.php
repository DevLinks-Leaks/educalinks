			...
			<div class="tab-content">
					...
					<div class="grid">
						...
						<div class="row">
							<div class="col-sm-1" style='text-align:left;font-size:small;'>
								<label class='control-label'>Per&iacute;odo anual</label>
							</div>
							<div class="col-sm-3">
								{combo_anual_deudas}
							</div>
				...
				<div role="tabpanel" class="tab-pane fade" id="ActulizacionPagos">
					<div class="grid">
						...
						<div class="row">
							<div class="col-sm-12">
								<p style='font-size:small;'><b>3. Actualización de DNA's a Facturas</b><br> Ahora que los DNA's tienen registrado sus respectivos pagos, los procedemos a convertir en FACTURAS.
									Presione 'Actualizar por lote' para realizar esta acción. De esta forma se culmina la migración a Contífico.</p>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-12">
