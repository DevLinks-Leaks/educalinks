	<aside class="main-sidebar">
        <section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="{menuRepr02}"><a href="../../alumnos/clases.php"><i class="fa fa-bell-o"></i><span> Clases</span></a></li>
				<li class="{menuRepr03}"><a href="../../alumnos/notas.php"><i class="fa fa-book"></i><span> Notas</span></a></li>
