<div class="container-fluid theme-showcase" role="main">
    ...
    <div class="box">
        ...
        <div class="box-body" id="div_libro_main" >
            <div class="row">
                <div class="col-md-12">
                    <table id="tbl_recursos" class="cell-border" cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                <th>Título</th>
                                <th>ISBN / ISSN</th>
                        ...
                        ?>
                            <tr>
                                <td width="40%"><?= $row_recu_view['recu_titu'];?> </td>
                                ...
                                <td width="20%">
                                	<a  href="item.php?recu_codi=<?= $row_recu_view['recu_codi']?>"
                                     class="btn btn-success" >
                                    <span class="fa fa-list" aria-hidden="true"></span> Ver Items
                                    </a>
