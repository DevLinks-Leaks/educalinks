...
<table class="table table-striped">
	...
	?>
		<tr>
			...
			<td><?= ($row["extension"]!=NULL?"<a title='Haga click para descargar' target='_blank' class='label-success' href='uploaded_docs/doc_".$asp_id."_".$row["docu_peri_codi"].".".$row["extension"]."'><span class='fa fa-download'></span> Descargar</a>":"<span class='label-warning input'>NO SUBIDO</span>") ?></td>
		</tr>
	<?php
	}
	?>
