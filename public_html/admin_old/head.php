...
?>
	<head>
        ...
        <!-- Shortcuts -->
        <script type="text/javascript" src="../includes/common/shortcut.js?<?= $rand?>"></script>
        <script type="text/javascript" src="js/shotcuts_admin.js"></script>
        <!-- Slick Carousel -->
        ...
        <!-- Input Mask -->
        <!-- <script src="../includes/common/plugins/input-mask/inputmask.min.js"></script> -->
