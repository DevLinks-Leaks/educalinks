<?php
	...
	$objPHPExcel->getActiveSheet()->getStyle("A1:BN1")->applyFromArray($style_cabecera);
	$objPHPExcel->getActiveSheet()->getRowDimension(1)->setRowHeight(40);
	$objPHPExcel->getActiveSheet()->getStyle("A2:BN2")->applyFromArray($style_cabecera);
	...
	$objPHPExcel->setActiveSheetIndex(0)->mergeCells('BL1:BN1');
