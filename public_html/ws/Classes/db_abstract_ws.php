...
abstract class DB_Abstract_ws{
    ...
    private function open_connection(){    
        ...
        $this->connectionInfo = array("Database"=>$this->name_db, "UID"=>$this->user_db, "PWD"=>$this->pass_db
                                      ,"CharacterSet"=>"UTF-8");
		
        $this->conn= sqlsrv_connect($this->host_db,$this->connectionInfo);
        if( $this->conn === false){
