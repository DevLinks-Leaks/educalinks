<?php
if(!class_exists('DB_Abstract_ws_certus')){include 'db_abstract_ws_certus.php';}
if(!class_exists('DB_Abstract_ws_certus')){include 'Classes/db_abstract_ws_certus.php';}
if(!class_exists('DB_Abstract_ws_certus')){include '../db_abstract_ws_certus.php';}
class Clientes extends DB_Abstract_ws_certus
{
	private $host_client;
	private $db_client;
	private $uid_client;
