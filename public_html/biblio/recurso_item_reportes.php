...
<html lang="es">
	...
	<body class="hold-transition skin-blue sidebar-mini <?php echo $_SESSION['sidebar_status']; ?>">
		<div class="wrapper">
			...
			<?php $Menu = 104; include("Templates/menu.php");?>
			<div class="content-wrapper">
				<section class="content-header">
					...
					<!-- <ol class="breadcrumb">
						...
						<li class="active">Recursos Items Reporte</li>
					</ol> -->
				</section>
				<section class="content" id="formulario_recurso">
					<div id="Main_div" >
						<div id="recurso_reporte_main" > 
							<?php include("recurso_item_reportes_view.php"); ?>
						</div>
					</div>
				</section>
		...
		<script>
		    $(document).ready(function() {
		        $('#tbl_recursos_items_reportes').addClass( 'nowrap' ).DataTable({
					dom: 'Bfrtip',
					buttons: [ 
