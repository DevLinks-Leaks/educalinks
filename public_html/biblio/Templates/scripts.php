...
<!-- Latest compiled and minified JQuery 
  ...
  <script src="../../includes/common/plugins/timepicker/bootstrap-timepicker.min.js"></script>
  <!-- Bootstrap WYSIHTML5 -->
  ...
  <script type="text/javascript" src="js/funciones_tipos.js?<?= $rand?>"></script>
  <script type="text/javascript" src="js/funciones_autores.js?<?= $rand?>"></script>
  <script type="text/javascript" src="js/funciones_procedencias.js?<?= $rand?>"></script>
  <script type="text/javascript" src="js/funciones_colecciones.js?<?= $rand?>"></script>
